...
const DJANGO_BACKGROUND_TASK_ENTRYPOINT = 'api/django_background_task.py';

/** Source injected into the auto-generated consumer entrypoint. */
const djangoBackgroundTaskSource =
  '# Auto-generated by Vercel. Do not edit.\n' +
  'from vercel_runtime._internal.django_queue import app\n';
...
`;
  ...
  // Read experimentalTriggers for this entrypoint from vercel.json config.
  ...
  const output = new Lambda({
    ...
    experimentalTriggers: lambdaOptions.experimentalTriggers,
  });
